...
|---|---|---|
| Repo access for the technical jury (public, single repo, DM to @Philippe Streit) | Sat 12:00 | ☐ |
| 1-minute video, real screen recording, link by Discord DM | **Sun 09:00** | ☐ |
| Code walkthrough with the technical jury | Sun 08:30–11:00 | ☐ |
| One landscape pitch page (PPTX or PDF) | Sun 12:00 | ☐ |
| Technical jury documentation, per official template | Sun 12:00 | ☐ |
| Hands-off — no more changes on `main` | **Sun 12:00** | ☐ |

Incomplete submissions are excluded from judging.
