...
const FUNCTION_ENTRIES: CatalogEntry[] = [
  ...
  },
  {
    ...
    title: 'Signale',
    path: 'Home',
    keywords: ['veränderung', 'was ist neu', 'teurer geworden', 'preiserhöhung', 'lohnerhöhung', 'hinweise'],
    icon: 'bell',
    target: { type: 'screen', screen: { name: 'signals' } },
  },
  {
    id: 'fn.assign',
    kind: 'function',
    ...
    path: 'Signale',
    keywords: ['zuordnen', 'kategorie ändern', 'umkategorisieren', 'unbekannte buchung', 'topf'],
    icon: 'sliders',
    target: { type: 'screen', screen: { name: 'assign' } },
  },
  {
    id: 'fn.budgetWizard',
    kind: 'function',
    ...
    path: 'Cockpit · Budget',
    keywords: ['budget anlegen', 'budget einrichten', 'assistent', 'zwei fragen', 'richtwert setzen'],
    icon: 'sliders',
    target: { type: 'screen', screen: { name: 'budgetWizard' } },
  },
  {
    id: 'fn.settings',
    kind: 'function',
